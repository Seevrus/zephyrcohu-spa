...
@Component({
  selector: "app-knowledgebase-article-list-item",
  host: {
    class: "app-knowledgebase-article-list-item",
  },
  imports: [MatChip, RouterLink],
  templateUrl: "./knowledgebase-article-list-item.component.html",
  styleUrl: "./knowledgebase-article-list-item.component.scss",
})
export class KnowledgebaseArticleListItemComponent {
