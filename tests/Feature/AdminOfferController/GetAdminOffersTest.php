...
describe('Get Admin Offers', function () {
    beforeEach(function () {
        Carbon::setTestNowAndTimezone('2026-02-28 21:59:40', 'Europe/Budapest');
        resetGetAdminOffersTestData();
    });

    test('lists all offers for an admin, including unpublished, ordered by publishedAt desc', function () {
...
function resetGetAdminOffersTestData(): void {
