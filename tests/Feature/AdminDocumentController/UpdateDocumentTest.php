...
describe('Update Document', function () {
    ...
    test('updates the metadata only and leaves the file alone', function () {
        ...
        Storage::disk('public')->assertExists('integra/tajekoztato/flyer-2026.pdf');
        expect(Storage::disk('public')->get('integra/tajekoztato/flyer-2026.pdf'))->toBe('flyer contents');
    });
    ...
    test('moves the file when only the category changes, including a public-to-local move', function () {
        ...
        Storage::disk('local')->assertExists('integra/programfrissites/flyer-2026.pdf');
        expect(Storage::disk('local')->get('integra/programfrissites/flyer-2026.pdf'))->toBe('flyer contents');

        $this->assertDatabaseHas('documents', [
            'id' => 1,
            'category' => 'programfrissites',
            'path' => 'integra/programfrissites/flyer-2026.pdf',
        ]);
    });
    ...
    test('replacing the file deletes the old one and stores the new one', function () {
        ...
        Storage::disk('public')->assertMissing('integra/tajekoztato/flyer-2026.pdf');
        Storage::disk('public')->assertExists('integra/tajekoztato/flyer-2026-v2.pdf');

        $this->assertDatabaseHas('documents', [
            'id' => 1,
            'path' => 'integra/tajekoztato/flyer-2026-v2.pdf',
        ]);
    });
    ...
    test('a duplicate filename at the destination category rejects the category move and changes nothing', function () {
        ...
        Storage::disk('public')->put('integra/egyeb/flyer-2026.pdf', 'other contents');
        ...
        Storage::disk('public')->assertExists('integra/tajekoztato/flyer-2026.pdf');
        expect(Storage::disk('public')->get('integra/egyeb/flyer-2026.pdf'))->toBe('other contents');
    ...
    test('a duplicate filename at the destination category rejects a replacement upload and changes nothing', function () {
        ...
        Storage::disk('public')->put('integra/tajekoztato/flyer-2026-v2.pdf', 'other contents');
        ...
        Storage::disk('public')->assertExists('integra/tajekoztato/flyer-2026.pdf');
        expect(Storage::disk('public')->get('integra/tajekoztato/flyer-2026-v2.pdf'))->toBe('other contents');
