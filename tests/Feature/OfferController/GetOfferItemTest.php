...
describe('Get Offer Item', function () {
    beforeEach(function () {
    ...
    test('returns 401 if the user is not logged in and tries to retrieve an authorized offer item', function () {
        $response = $this->getJson('/api/offers/3');
    ...
    test('retrieves auth offer for a logged in user', function () {
        Sanctum::actingAs(
            User::find(1),
        );
...
function resetGetOfferItemTestData(): void {
