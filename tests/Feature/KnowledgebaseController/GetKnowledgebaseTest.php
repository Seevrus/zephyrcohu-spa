...
describe('Get Knowledgebase', function () {
    beforeEach(function () {
        Carbon::setTestNowAndTimezone('2026-02-08 21:46:00', 'Europe/Budapest');
        resetGetKnowledgebaseTestData();
    });

    test('retrieves paginated knowledgebase articles in the correct order for guest users', function () {
    ...
    test('returns data from the second page', function () {
        $response = $this->getJson('/api/knowledgebase?page=2');
    ...
    test('returns knowledgebase articles for logged in users, including whether they read them', function () {
        Sanctum::actingAs(
            User::find(1),
        );
    ...
    test('filters the list by tag id', function () {
        $response = $this->getJson('/api/knowledgebase?tag=2');
    ...
    test('returns an empty list when no article has the given tag', function () {
        $response = $this->getJson('/api/knowledgebase?tag=3');
    ...
    test('returns a validation error for a non-existent tag id', function () {
...
function resetGetKnowledgebaseTestData(): void {
