...
describe('Get Knowledgebase Item', function () {
    beforeEach(function () {
    ...
    test('returns 401 if the user is not logged in and tries to retrieve an authorized knowledgebase item', function () {
        $response = $this->getJson('/api/knowledgebase/3');
    ...
    test('retrieves auth knowledgebase item for a logged in user', function () {
        Sanctum::actingAs(
            User::find(1),
        );
...
function resetGetKnowledgebaseItemTestData(): void {
